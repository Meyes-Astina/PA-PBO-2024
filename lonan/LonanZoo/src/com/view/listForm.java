...
public class listForm extends javax.swing.JFrame {
    ...
    try {
        ...
        String selectedCategory = (String) jComboBox1.getSelectedItem(); // Mengambil kategori yang dipilih dari combo box
        String query = "SELECT nama, habitat, jenis, asal, jumlah FROM data_zoo WHERE kategori = ?";
        ...
        while (rs.next()) {
            ...
            model.addRow(new Object[]{nama, habitat, jenis, asal, jumlah, selectedCategory});
        }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama", "Habitat", "jenis", "asal", "jumlah", "kategori"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 160, -1, 360));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 543, -1, 30));

        jComboBox1.setBackground(new java.awt.Color(74, 163, 179));
        jComboBox1.setForeground(new java.awt.Color(255, 255, 255));
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "mamalia", "unggas", "reptil", " " }));
        jComboBox1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBox1ActionPerformed(evt);
            }
        });
        jPanel1.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 542, -1, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        AdminList admenu = new AdminList();
        admenu.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jComboBox1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBox1ActionPerformed
    String selectedCategory = (String) jComboBox1.getSelectedItem(); // Mendapatkan kategori yang dipilih dari combo box
